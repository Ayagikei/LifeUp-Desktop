...
import lifeupdesktop.composeapp.generated.resources.download_24px
...
import net.lifeupapp.app.ui.theme.important
    ...
    Column(modifier) {
        TopAppBar(title = {
            ...
            IconButton(onExportClicked) {
                Icon(vectorResource(Res.drawable.download_24px), "Export")
            }
